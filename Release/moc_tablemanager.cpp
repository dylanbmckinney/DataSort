...
#include "../../DataSort/tablemanager.h"
...
void TableManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TableManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TableManager::done)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TableManager::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_TableManager.data,
      qt_meta_data_TableManager,  qt_static_metacall, nullptr, nullptr}
};
