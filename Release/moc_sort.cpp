...
QT_MOC_LITERAL(3, 11, 8) // "progress"

    },
    "Sort\0done\0\0progress"
};
...
void Sort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Sort::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sort::done)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Sort::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sort::progress)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Sort::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Sort.data,
...
// SIGNAL 1
void Sort::progress(int _t1, int _t2)
{
